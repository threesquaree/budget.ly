...
export default function Example() {
  ...
  <div class="bg-off-white">
    ...
    <h1 className="text-white text-2xl font-custom" style={{ display: 'flex', alignItems: 'center' }}>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8" style={{ marginRight: '10px' }}>
    ...
    budget.ly
      ...
      <div class="absolute top-40" >
        <h1 class="text-white text-2xl">Welcome, Nayan</h1>
        <p class="text-silver text-m mt-2">We're here to help manage your money!</p>
      </div>
      <div className='flex flex-col lg:flex-row gap-3 justify-between'>
      
        {DATA?.map((d, index) => (
          <div key={index} class="relative w-1/3 h-60 shadow-md bg-white rounded-lg border border-gray-300 top-40 float-left transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg border border-white border-opacity-10 rounded-lg p-4">
